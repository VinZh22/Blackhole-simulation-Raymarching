...
{
	// This is a dummy variable used for compatibilty with camera orbit euler and ray sourcce
	mat4 dummy_camera_view; // If enough time, this should be removed
	...
	void send_opengl_uniform(opengl_shader_structure const& shader, bool expected = false) const override;
};
